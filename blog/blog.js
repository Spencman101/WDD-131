...
articles.forEach((article) => {
	...
	newArticle.classList.add('book-post');
	...
	const articleHTML = `
    	...
    	<div class="info">
    	    <h2 id="book_title">${article.title}</h2>
    	    <img id="cover" src="${article.imgSrc}" alt="${article.imgAlt}">
    	    <p id="summary">${article.description}</p>
    	</div>
	`;
