...
recipes.forEach((recipes) => {
	...
	const articleHTML = `<figure class="recipe">
	<img src="${recipe.image}" alt="image of apple crisp on a plate" />
	<figcaption>
	...
	newRecipe.innerHTML = articleHTML;
	mainContent.appendChild(newRecipe);
});
